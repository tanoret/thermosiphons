...
The thermosyphon model adds a conservative upward heat flux between a deeper soil cell and a near-surface cell when the deeper cell is warmer than the top cell by the startup margin. Heat flux is limited by pipe conductance, pipe capacity, fluid temperature envelope, spacing/tributary area, and a numerical equalization limiter.
