...
def _candidate_table(
    ...
    for d in _candidate_designs(max_depth_m=max_depth_m, fluid=fluid, aggressive=aggressive):
        ...
        cost = estimate_project_cost(area_m2, d, install_type, region_factor=region_factor, factory_heat_pipe_unit_cost=factory_heat_pipe_unit_cost)
        rows.append(
            {
...
def optimize_design(
    ...
    candidates = _candidate_table(
        ...
        max_depth_m,
        fluid,
        factory_heat_pipe_unit_cost=factory_heat_pipe_unit_cost,
    )
    if candidates.empty:
    ...
    for idx in idxs:
        ...
        cost = estimate_project_cost(area_m2, design, install_type, region_factor=region_factor, factory_heat_pipe_unit_cost=factory_heat_pipe_unit_cost)
